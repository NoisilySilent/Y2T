------------------------------------------------------------------------------
-- edid_emu.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          edid_emu.vhd
-- Version:           1.00.a
-- Description:       Top level design, instantiates library components and user logic.
-- Date:              Tue May  4 21:44:58 2021 (by Create and Import Peripheral Wizard)
...
use edid_emu_v1_00_a.user_logic;
...
entity edid_emu is
  ...
  (
    ...
    C_DDC_BASEADDR               : std_logic_vector     := X"FFFFFFFF";
...
architecture IMP of edid_emu is

  constant USER_DDC_GIE                 : std_logic_vector     := C_DDC_BASEADDR + X"01C";
  constant USER_DDC_ISR                 : std_logic_vector     := C_DDC_BASEADDR + X"020";
  constant USER_DDC_IER                 : std_logic_vector     := C_DDC_BASEADDR + X"028";
  constant USER_DDC_SOFTR               : std_logic_vector     := C_DDC_BASEADDR + X"040";
  constant USER_DDC_CR                  : std_logic_vector     := C_DDC_BASEADDR + X"100";
  constant USER_DDC_SR                  : std_logic_vector     := C_DDC_BASEADDR + X"104";
  constant USER_DDC_Tx_FIFO             : std_logic_vector     := C_DDC_BASEADDR + X"108";
  constant USER_DDC_Rc_FIFO             : std_logic_vector     := C_DDC_BASEADDR + X"10C";
  constant USER_DDC_ADR                 : std_logic_vector     := C_DDC_BASEADDR + X"110";
  constant USER_DDC_Tx_FIFO_OCY         : std_logic_vector     := C_DDC_BASEADDR + X"114";
  constant USER_DDC_Rc_FIFO_OCY         : std_logic_vector     := C_DDC_BASEADDR + X"118";
  constant USER_DDC_TEN_ADR             : std_logic_vector     := C_DDC_BASEADDR + X"11C";
  constant USER_DDC_Rc_FIFO_PIRQ        : std_logic_vector     := C_DDC_BASEADDR + X"120";
  constant USER_DDC_GPO                 : std_logic_vector     := C_DDC_BASEADDR + X"124";
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity edid_emu_v1_00_a.user_logic
    generic map
    (
      -- MAP USER GENERICS BELOW THIS LINE ---------------
      C_DDC_GIE                    => USER_DDC_GIE,
      C_DDC_ISR                    => USER_DDC_ISR,
      C_DDC_IER                    => USER_DDC_IER,
      C_DDC_SOFTR                  => USER_DDC_SOFTR,
      C_DDC_CR                     => USER_DDC_CR,
      C_DDC_SR                     => USER_DDC_SR,
      C_DDC_Tx_FIFO                => USER_DDC_Tx_FIFO,
      C_DDC_Rc_FIFO                => USER_DDC_Rc_FIFO,
      C_DDC_ADR                    => USER_DDC_ADR,
      C_DDC_Tx_FIFO_OCY            => USER_DDC_Tx_FIFO_OCY,
      C_DDC_Rc_FIFO_OCY            => USER_DDC_Rc_FIFO_OCY,
      C_DDC_TEN_ADR                => USER_DDC_TEN_ADR,
      C_DDC_Rc_FIFO_PIRQ           => USER_DDC_Rc_FIFO_PIRQ,
      C_DDC_GPO                    => USER_DDC_GPO,
