...
Peripheral Summary:
  ...
  XPS project / EDK repository               : /opt/Xilinx/Projects/PLB_EDID
  logical library name                       : edid_emu_v1_00_a
  top name                                   : edid_emu
  version                                    : 1.00.a
...
plbv46_slave_single_v1_01_a
	/xilinx/14.7/ISE_DS/EDK/hw/XilinxProcessorIPLib/pcores/plbv46_slave_single_v1_01_a/doc/plbv46_slave_single.pdf

plbv46_master_single_v1_01_a
	/xilinx/14.7/ISE_DS/EDK/hw/XilinxProcessorIPLib/pcores/plbv46_master_single_v1_01_a/doc/plbv46_master_single.pdf
...
IP2Bus_Mst_Reset
    User logic master reset request(optional). 
...
Bus2IP_Mst_Cmd_Timeout
    Master command timeout status to the user logic. 

Bus2IP_MstRd_d
    Master read LocalLink data input to the user logic. 

Bus2IP_MstRd_src_rdy_n
    Active low signal that indicates that the data value asserted on the 
...
Bus2IP_MstWr_dst_rdy_n
    Active low signal that indicates that the data value asserted on the 
    IP2Bus_MstWr_d bus is accepted by the write LocalLink destination. 
